...
const PostDetail: React.FC = () => {
   ...
   const descriptions = post.description
      ? post.description.slice(0, 160) // lấy tối đa ~160 ký tự
      : post.title;
   return (
      <Container>
         <Helmet>
            <title>{post.title} | CP Land</title>
            <meta name="description" content={descriptions} />
            <meta property="og:title" content={post.title} />
            <meta property="og:description" content={descriptions} />
            <meta property="og:image" content={post.images[0]?.url} />
            <meta property="og:url" content={`https://cpland.net/du-an/${post.id}`} />
         </Helmet>
         ...
         <PostDetailbody>
            ...
            <InfoDetail>
               <Meta>
                  ...
                  |<span>Diện tích: {post.area} m²</span> | <span>Loại: {type}</span>
               </Meta>

               <Info>
                  <strong>Địa chỉ:</strong> {post.address.street && `${post.address.street}, `}
