   ...
   return (
      <Background>
         ...
         <Footer>
            ...
            <InforFooter>
               <InforItem>
                  <MdMapsHomeWork color="white" size={25} />
                  <span>Công ty cổ phần CP-Land</span>
               </InforItem>
               <InforItem>
                  <LiaMapMarkedAltSolid color="white" size={25} />
                  Địa chỉ: Thôn: Đống Vừng, Xã: Bắc Lũng, Tỉnh: Bắc Ninh
               </InforItem>
            </InforFooter>
            <InforFooter>
               <InforItem>
                  <PiVibrateLight color="white" size={25} />
                  SĐT: 0339957868
               </InforItem>
               <InforItem>
                  <AiOutlineGlobal color="white" size={25} />
                  Wedsite: cpland.net
               </InforItem>
               <InforItem>
                  <AiOutlineMail color="white" size={25} />
                  Email: cpland.thongtin@gmail.com
               </InforItem>
            </InforFooter>
         </Footer>
         <ModalGroup>
